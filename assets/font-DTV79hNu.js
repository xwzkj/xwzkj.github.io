...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    useCssVars((_ctx) => ({
      "32524d94": unref(lyricWordNowDuration)
    }));
    let props = __props;
...
const lyricLine = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-f1c86498"]]);
...
export {
  ...
  identity as aa,
  baseFor as ab,
  configProviderInjectionKey as ac,
  watchEffect as ad,
  cssrAnchorMetaName as ae,
  globalStyle as af,
  cB as ag,
  c as ah,
  Transition as ai,
  commonVariables as aj,
  cE as ak,
  cM as al,
  cNotM as am,
