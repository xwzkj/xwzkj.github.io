import{t as f,n as y,y as k,e as E,u as gt,bf as Nt,l as u,c as Ot,d as jt,bg as Lt,bh as J,bi as O,bj as Q,bk as ne,bl as j,bm as he,bn as oe,r as _,ad as pe,ae as ge,g as V,bo as Zt,f as bt,j as mt,ar as Gt,bp as ke,bq as Le,br as Ze,bs as Ge,aD as Kt,x as nt,aa as Xt,bt as Yt,A as vt,p as Jt,D as De,C as ot,w as xt,E as Qt,B as Wt,b4 as er,T as tr,k as rr,F as Ce,az as it,ab as ar,I as We,J as et,K as ae,Y as z,P as x,bu as ze,V as kt,W as nr,am as Te,Q as F,Z as or,bv as ir}from"./index-CD6o7Giz.js";import{_ as yt,N as lr}from"./plugin-vueexport-helper-CvwgGIEE.js";import{b as sr,B as fe}from"./Button-CRBat-eq.js";import{_ as ur}from"./Card-Btc3FDva.js";import{f as dr}from"./fade-in-scale-up.cssr-CsrCMAGI.js";import{u as Ke,B as cr,V as fr,b as hr,c as pr}from"./Follower-DLOt2EUa.js";function wt(e,r,t){r/=100,t/=100;const a=r*Math.min(t,1-t)+t;return[e,a?(2-2*t/a)*100:0,a*100]}function $e(e,r,t){r/=100,t/=100;const a=t-t*r/2,n=Math.min(a,1-a);return[e,n?(t-a)/n*100:0,a*100]}function X(e,r,t){r/=100,t/=100;let a=(n,o=(n+e/60)%6)=>t-t*r*Math.max(Math.min(o,4-o,1),0);return[a(5)*255,a(3)*255,a(1)*255]}function Xe(e,r,t){e/=255,r/=255,t/=255;let a=Math.max(e,r,t),n=a-Math.min(e,r,t),o=n&&(a==e?(r-t)/n:a==r?2+(t-e)/n:4+(e-r)/n);return[60*(o<0?o+6:o),a&&n/a*100,a*100]}function Ye(e,r,t){e/=255,r/=255,t/=255;let a=Math.max(e,r,t),n=a-Math.min(e,r,t),o=1-Math.abs(a+a-n-1),s=n&&(a==e?(r-t)/n:a==r?2+(t-e)/n:4+(e-r)/n);return[60*(s<0?s+6:s),o?n/o*100:0,(a+a-n)*50]}function Je(e,r,t){r/=100,t/=100;let a=r*Math.min(t,1-t),n=(o,s=(o+e/30)%12)=>t-a*Math.max(Math.min(s-3,9-s,1),-1);return[n(0)*255,n(8)*255,n(4)*255]}const gr=f("input-group",`
 display: inline-flex;
 width: 100%;
 flex-wrap: nowrap;
