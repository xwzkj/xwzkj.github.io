...
const buildInfo = { version: "1.1.7", buildNumber: "dac2b16", buildTime: "2025-09-07 12:26:48" };
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    let defaultSpecialApi = ref((_a = localStorage.getItem("specialApi")) != null ? _a : "");
    let levelData = [
    ...
    function copyCk() {
      return __async(this, null, function* () {
        ...
        if (navigator.clipboard) {
          try {
            yield navigator.clipboard.writeText(ck);
            flag = true;
            success("复制成功");
          } catch (e) {
          }
...
const setting = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-1a51e0a5"]]);
export {
  setting as default
};
